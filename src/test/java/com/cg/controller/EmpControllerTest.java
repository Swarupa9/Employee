...
public class EmpControllerTest {
    ...
    public void testHealthCheck() {
    	...
    	ResponseEntity<String> response = empController.healthCheck();
    ...
    public void testGetAllEmployees() {
        ...
        ResponseEntity<List<EmpBO>> response = empController.getAllEmployees();
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
        assertThat(response.getBody().get(0).getId()).isEqualTo(eBo.getId());
        assertThat(response.getBody().get(0).getEmp_Name()).isEqualTo(eBo.getEmp_Name());
        assertThat(response.getBody().get(0).getEmp_EmailId()).isEqualTo(eBo.getEmp_EmailId());
        assertThat(response.getBody().get(0).getEmp_Age()).isEqualTo(eBo.getEmp_Age());
    }
    ...
    public void testGetEmployeeById() {
        ...
        ResponseEntity<EmpBO> response = empController.getEmployeeById(1L);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
        assertThat(response.getBody()).isNotNull();
...
//        HttpEntity<EmpBO> request = new HttpEntity<>(eBo, headers);
        ...
        ResponseEntity<EmpBO> response = empController.createEmployee(eBo);
